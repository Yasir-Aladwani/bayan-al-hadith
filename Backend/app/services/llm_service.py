...
إذا كان السؤال يحتوي على أكثر من موضوع أو أكثر من حكم:

- قم بتقسيم السؤال إلى عدة استفسارات.
...
يصبح:
hadith_queries: ["حكم السحر", "حكم الربا"]
quran_queries: ["السحر", "الربا"]

إذا كان السؤال يطلب مقارنة أو فرق:

- اجعل mode = fiqh
- استخرج queries لكل مفهوم على حدة
- لا تدمجهم في query واحدة
...
إذا كان السؤال يحتوي على أكثر من حكم:

- اكتب لكل موضوع حكمه بشكل منفصل
- لا تدمج الأحكام في فقرة واحدة
